<%-- 
    ...
    Created on : Nov 23, 2020, 10:24:04 AM
    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <<div class="content-wrapper">
                ...
                <mvc:form modelAttribute="batch" action="addNewBatch" method="post">
                    <table>
                        <tr>
                            <td>Center(*):</td>
                        ...
                        <tr>
                            <td>Class Name(*):</td>
                            <td><mvc:input path="className" required="true"/></td>
                        </tr>
                        <tr>
                            <td>Batch Status(*):</td>
                            <td><mvc:input path="batchStatus" required="true"/></td>
                        </tr>
